                ...
                <div className="login__forms">
                    <form onSubmit={handleSubmit} className="login__create">
                        ...
                        <div>
                            ...
                            &nbsp;
                            <span className="login__signin login__signin--signup" onClick={() => navigate('/')}>로그인</span>
                        </div>
                    </form>
                </div>
            </div>
...
function SignUpSecond() {
    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ height: '95vh' }}>
            <Card className="box" style={{ minWidth: '500px', maxWidth: '600px' }}>
                <Card.Header className="box" style={{ fontSize: "20px", fontWeight: "bold" }}>EduNavi에 오신 것을 환영합니다!</Card.Header>
                <Card.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button id="btnJoin" type="submit" variant="primary" style={{ width: '200px', marginBottom: "10px", marginTop: "20px", backgroundColor: "#ff9c5f", fontWeight: "bold", display: "block", margin: "0 auto" }}>
                            가입하기
                        </Button>
